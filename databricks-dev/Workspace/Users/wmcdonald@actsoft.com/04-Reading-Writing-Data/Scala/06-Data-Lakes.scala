...
val adlsAccountName = "<your-data-lake-store-account-name>"
...
dbutils.fs.mount(
  source = s"adl://$adlsAccountName.azuredatalakestore.net/",
  mountPoint = "/mnt/adls",
...
val crimeDataNewYorkDF = spark.read.parquet("/mnt/adls/training/crime-data-2016/Crime-Data-New-York-2016.parquet")

// COMMAND ----------

val crimeDataBostonDF = spark.read.parquet("/mnt/adls/training/crime-data-2016/Crime-Data-Boston-2016.parquet")
...
// MAGIC %md
// MAGIC ## Next Steps
// MAGIC * Continue to the [Azure Data Lake Storage Gen2]($./07-Azure-Data-Lake-Gen2) lesson