...
val ipGeocodeDF = spark.read.parquet("/mnt/training/ip-geocode.parquet")
...
val file="/FileStore/tables/state_income-9f7c5.csv"
val stateIncomeDF = spark.read.option("inferSchema","true").option("header","true").csv(file)
...
val SasURL = "https://databrickstraining.blob.core.windows.net/?sv=2017-07-29&ss=bf&srt=sco&sp=rl&se=2019-03-16T00:34:34Z&st=2018-03-15T16:34:34Z&spr=https&sig=PGYDInOv1m8zM0xAG%2Bu%2FWJVt2%2FhivzCa4cdAUH7buMA%3D"
val SasKey = SasURL.slice(SasURL.indexOf('?'), SasURL.length)
val StorageAccount = "dbtraineastus2"
val ContainerName = "training-primary"
val MountPoint = "/mnt/temp-training"
dbutils.fs.mount(
